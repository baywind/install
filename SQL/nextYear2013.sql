...
CREATE TABLE BASE_SETTINGS (
  ...
  from RujelYear2012.BASE_SETTINGS
  WHERE SETTING_KEY != "CompletionActive" and SETTING_KEY != "coursesDone";
...
CREATE TABLE BASE_QUALIFIED_SETTINGS (
  ...
  from RujelYear2012.BASE_QUALIFIED_SETTINGS
...
INSERT INTO PL_EDU_PERIOD (P_ID, EDU_YEAR, DATE_BEGIN, DATE_END, SHORT_TITLE, FULL_NAME, ITOG_ID)
  SELECT P_ID, EDU_YEAR +1, DATE_BEGIN + INTERVAL 1 YEAR AS DATE_BEGIN, DATE_END + INTERVAL 1 YEAR AS DATE_END, SHORT_TITLE, FULL_NAME, ITOG_ID
  from RujelYear2012.PL_EDU_PERIOD;

CREATE TABLE PL_PERIOD_LIST (
  PRIMARY KEY (PL_ID)
) ENGINE=InnoDB
  SELECT PL_ID, EDU_PERIOD, LIST_NAME
  from RujelYear2012.PL_PERIOD_LIST;
