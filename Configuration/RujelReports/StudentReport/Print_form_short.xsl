...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru">
	...
	@page {
                size: 21cm 29.7cm;
                margin: 10mm 10mm 10mm 5mm; /* change the margins as you want them to be. */
        }
        .newspaper {
...
<!--	<xsl:if test="$options/info/eduYear">
	<div style="float:right;"><xsl:value-of select="$options/info/eduYear"/></div>
	</xsl:if>
	...
	<tr><td>Предмет</td><td>	<xsl:if test="$options/info/dates">
	<div class = "dates"><xsl:value-of select="$options/info/dates"/></div>
	</xsl:if></td><td>Пр-з</td></tr></thead>
...
<!--			<tr height="5"></tr> -->
	...
	<tr><td colspan="3"><br></br>Подпись родителя:
	<br></br><br></br>
	Подпись классного руководителя:<br></br><br></br></td></tr>
	</table>
	</div>
</xsl:template>
...
<xsl:template name="progn">
	<xsl:param name="mark"/>
	<strong style=""><xsl:value-of select="$mark/@value"/></strong>
