...
echo Launching %~n0.
echo %JAVAEXE% %JVMOPTS% %JAVAARGS% -classpath WOBootstrap.jar com.webobjects._bootstrap.WOBootstrap %THEARGS% -WOFrameworksBaseURL /WebObjects/PListWOEditor.woa/Frameworks
call %JAVAEXE% %JVMOPTS% %JAVAARGS% -classpath WOBootstrap.jar com.webobjects._bootstrap.WOBootstrap %THEARGS% -WOFrameworksBaseURL /WebObjects/PListWOEditor.woa/Frameworks
